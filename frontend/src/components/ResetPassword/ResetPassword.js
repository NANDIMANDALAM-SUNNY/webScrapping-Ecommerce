...
await axios.get(`https://webscrap-backend.onrender.com/users/reset-password/${token}`)
  .then((res)=>{
...
const handleSubmit =async ()=>{
  try {
      await axios.post(`https://webscrap-backend.onrender.com/users/new-password/${token}`,{"password":password})
      .then((res)=>{
        console.log(res.data)
